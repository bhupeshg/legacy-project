			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('karmi_name'); ?></th>
						<th><?php echo $this->Paginator->sort('initiated_name'); ?></th>
						<th><?php echo $this->Paginator->sort('place_of_initiation'); ?></th>
						<th><?php echo $this->Paginator->sort('date_of_initiation'); ?></th>
						<th><?php echo $this->Paginator->sort('profile_pic'); ?></th>
						<th><?php echo $this->Paginator->sort('status'); ?></th>
						<th><?php echo $this->Paginator->sort('legacy_status'); ?></th>
						<th><?php echo $this->Paginator->sort('memoir'); ?></th>
				...
				<?php foreach ($users as $user): ?>
					<tr>
						...
						<td><?php echo h($user['User']['legacy_status']); ?>&nbsp;</td>
						<td><?php echo h($user['User']['memoir']); ?>&nbsp;</td>
